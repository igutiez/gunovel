# libro_1_senales — instrucciones para Claude Code
...
**Identificador del proyecto:** `alianza/libro_1_senales`
...
Usa las tools del servidor `mcp__gunovel` pasándoles `proyecto_slug="alianza/libro_1_senales"`.
